<?php
// Orion: switch to sidebar-first panel when selected theme is 'orion'
$__selected_theme = !empty($_SESSION["userTheme"]) ? $_SESSION["userTheme"] : $_SESSION["THEME"];
if ($__selected_theme === "orion") {
	require $_SERVER["HESTIA"] . "/web/templates/includes/panel_orion.php";
	return;
}
?>
		...
		<div class="container top-bar-inner">
			...
			<div class="top-bar-left">
				...
				<a href="/" class="top-bar-logo" title="<?= htmlentities($_SESSION["APP_NAME"]) ?>">
					<img src="/images/logo.svg" alt="<?= htmlentities($_SESSION["APP_NAME"]) ?>" width="54" height="29">
				</a>
